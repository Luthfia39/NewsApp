...
public class listNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new newsAdapter(this, filter_news);
    ...
    private void addData() {
        news_all.add(new News("Film Korea yang Cocok Ditonton Bersama Keluarga", "Hiburan", "Film Korea menjadi salah satu tontonan populer yang banyak digemari orang Indonesia . Tak hanya menyajikan kisah romansa yang cocok ditonton bareng pasangan atau kekasih, " +
                "mereka juga memiliki banyak film dengan tema menarik yang bisa ditonton bersama keluarga di rumah, diantaranya : \n" + "- Little Forest\n" + "- Midnight Runners\n" + "- Wedding Dress\n" + "- Pawn", 19));
        news_all.add(new News("Rekomendasi Kartun untuk Anak", "Hiburan", "Rekomendasi kartun yang cocok untuk anak - anak :\n" +
                "- MY NEIGHBOOR IS TOTORO\n" + "- WALL-E\n" + "- COCO\n" + "- INSIDE OUT\n" + "- FINDING NEMO\n" + "- NUSSA\n" + "- MOANA\n" + "- FROZEN", 7));
        ...
        news_all.add(new News("Terkait Tragedi Kanjuruhan", "Olahraga", "Tim Gabungan Independen Pencari Fakta (TGIPF) tragedi Kanjuruhan meminta PSSI melakukan Kongres Luar Biasa untuk menghasilkan kepemimpinan dan kepengurusan yang berintegritas, profesional dan bertanggung jawab.\n" +
                "TGIPF dalam kesimpulan dan rekomendasi laporan hasil investigasi tragedi Kanjuruhan menuliskan agar Ketua Umum PSSI dan seluruh jajaran Komite Eksekutif mengundurkan diri sebagai bentuk pertanggung jawaban moral atas jatuhnya ratusan korban meninggal dan luka." , 15));
        ...
        news_all.add(new News("Jaga Solidaritas Polisi", "Politik", "Presiden Joko Widodo (Jokowi) meminta Polri untuk memperkuat soliditas hingga menjaga soliditas bersama TNI menjelang tahun politik yang akan berlangsung pada 2024 mendatang. " +
                "Soliditas untuk mengawal dan menjalan tugas pokok dan fungsi Polri dalam menjaga keamanan apalagi memasuki tahun politik dengan mengambil langkah-langkah tegas yang berdampak pada perpecahan dan polarisasi di masyarakat", 11));
